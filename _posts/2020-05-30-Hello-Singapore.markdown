...
2. 나는 위와 같이 씨앗들을 뿌리고 난 뒤, 싹이 돋아나는 상황을 대비해 충실히 공부하였다. 
...
4. 기술면접 준비를 위해 LeetCode, codility 등의 서비스를 적극 이용하여 문제풀이를 하였다. 
...
<br/>
<img src="/static/assets/img/posts/99co/99co-android.png" alt="pikachu" width="300">
<br/>
...
<img src="/static/assets/img/posts/99co/pikachu.png" alt="pikachu" width="20">

현재 나는 Pikachu 팀이다. 부동산을 탐색하려는 일반 유저를 포커싱한 서비스를 개발하는 팀이다.
여기에는 백엔드, 안드로이드, iOS, 웹 프론트엔드, 디자이너, PM 등 열댓명이 있다.

<img src="/static/assets/img/posts/99co/diglett.png" alt="diglett" width="20">
